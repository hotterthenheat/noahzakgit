...
export function PinpointAIView() {
  ...
  return (
    <div className="w-full text-zinc-100 flex flex-col font-mono select-none antialiased md:min-h-[580px] lg:h-[650px]">
      ...
      <div 
        className="w-full max-w-full flex-1 grid grid-cols-1 md:grid-cols-10 gap-4 h-full"
        style={{ minHeight: '520px' }}
      >
        
        {/* COLUMN 1: MARKET STORY (20%) */}
        <div className="md:col-span-2 flex flex-col bg-[#050505] border border-zinc-900 rounded-sm p-4 text-left justify-between">
        ...
        {/* COLUMN 3: CONTEXT (20%) */}
        <div className="md:col-span-2 flex flex-col bg-[#050505] border border-zinc-900 rounded-sm p-4 justify-between h-full text-left">
          <div className="space-y-4">
            <div className="border-b border-zinc-900 pb-2">
